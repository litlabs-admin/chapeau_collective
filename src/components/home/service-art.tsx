          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <stop offset="1" stopColor="#133F40" stopOpacity="0" />
              </linearGradient>
            </defs>
          </svg>
        ...
        <div className="relative h-[167px] w-[181px] rotate-[1deg]">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#83F6F8" />
                <stop offset="1" stopColor="#133F40" />
              </radialGradient>
            </defs>
          </svg>
...
function BrowserWindow() {
  return (
    <svg
      ...
      viewBox="0 0 175 131"
    >
      <path d="M2.3584 7.12938C2.3584 4.49444 4.49444 2.3584 7.12938 2.3584H167.587C170.222 2.3584 172.358 4.49444 172.358 7.12938V125.587C172.358 128.222 170.222 130.358 167.587 130.358H7.12938C4.49444 130.358 2.3584 128.222 2.3584 125.587V7.12938Z" fill="#1D595A" />
      <path d="M167.588 0C171.525 0 174.717 3.19164 174.717 7.12891V123.229C174.717 127.084 171.657 130.222 167.833 130.352C170.354 130.224 172.358 128.14 172.358 125.587V7.12938C172.358 4.49444 170.222 2.3584 167.587 2.3584H7.12938C4.49444 2.3584 2.3584 4.49444 2.3584 7.12938V125.587C2.35865 128.139 4.36264 130.223 6.88281 130.352C3.05939 130.222 0 127.084 0 123.229V7.12891C0 3.19164 3.19164 0 7.12891 0H167.588Z" fill="#3F8788" />
      <path d="M24.5109 28.9454C24.5109 27.6427 25.5669 26.5867 26.8696 26.5867H148.345C149.648 26.5867 150.704 27.6427 150.704 28.9454V50.1742C150.704 51.4769 149.648 52.5329 148.345 52.5329H26.8696C25.5669 52.5329 24.5109 51.4769 24.5109 50.1742V28.9454Z" fill="#133F40" />
      ...
      <path d="M10.3584 8.91847C10.3584 6.9523 11.9523 5.3584 13.9185 5.3584H162.476C164.442 5.3584 166.036 6.9523 166.036 8.91847V11.2553H10.3584V8.91847Z" fill="#336869" />
...
function DashboardPhone() {
  return (
    <div className="h-[111px] w-[92px] rounded-[7px] bg-[#1d595a] shadow-[0_0_0_2px_#3f8788]">
...
function TallPhone() {
  return (
    <svg
      ...
      viewBox="0 0 55 103"
    >
      <path d="M2.3584 7.07589C2.3584 4.47049 4.47049 2.3584 7.07589 2.3584H47.6409C50.2463 2.3584 52.3584 4.47049 52.3584 7.07589V97.6409C52.3584 100.246 50.2463 102.358 47.6409 102.358H7.07589C4.47049 102.358 2.3584 100.246 2.3584 97.6409V7.07589Z" fill="#1D595A" />
      <path d="M47.8838 102.352C50.3763 102.225 52.3584 100.165 52.3584 97.6409V7.07589C52.3584 4.47049 50.2463 2.3584 47.6409 2.3584H7.07589C4.47049 2.3584 2.3584 4.47049 2.3584 7.07589V97.6409C2.3584 100.165 4.33998 102.225 6.83203 102.352C3.03691 102.223 0 99.1086 0 95.2822V7.07617C0 3.16807 3.16807 0 7.07617 0H47.6406C51.5487 0 54.7168 3.16807 54.7168 7.07617V95.2822C54.7168 99.0682 51.7438 102.16 48.0049 102.35L47.8838 102.352Z" fill="#3F8788" />
      <path d="M7.3584 23.333C7.3584 22.0303 8.41444 20.9743 9.71714 20.9743H45.0983C46.401 20.9743 47.4571 22.0303 47.4571 23.333V44.5618C47.4571 45.8645 46.401 46.9205 45.0983 46.9205H9.71715C8.41445 46.9205 7.3584 45.8644 7.3584 44.5617V23.333Z" fill="#133F40" />
